...
public final class YoungAndroidStructureConstants {
  ...
  /**
   * The filename containing project translation data.
   */
  public static final String TRANSLATIONS_FILE_NAME = "translations.json";

  /**
   * The project-relative path containing project translation data.
   */
  public static final String TRANSLATIONS_FILE =
      PROJECT_DIRECTORY + "/" + TRANSLATIONS_FILE_NAME;
